...
const currentCategories: BudgetCategory[] = [
  { id: "cat-debt", name: "Debt Payments", planned: 8000, group: "reserved", cutoffId: currentCutoffId, locked: true },
  { id: "cat-bills", name: "Monthly Bills", planned: 9000, group: "reserved", cutoffId: currentCutoffId, locked: true },
  { id: "cat-family", name: "Family Share", planned: 5000, group: "reserved", cutoffId: currentCutoffId, locked: true },
  { id: "cat-food", name: "Food", planned: 7000, group: "spendable", cutoffId: currentCutoffId, locked: true },
  { id: "cat-parking", name: "Parking", planned: 1500, group: "spendable", cutoffId: currentCutoffId, locked: true },
  { id: "cat-gas", name: "Gas", planned: 3500, group: "spendable", cutoffId: currentCutoffId, locked: true },
  { id: "cat-savings", name: "Savings", planned: 10000, group: "savings", cutoffId: currentCutoffId, locked: true },
  { id: "cat-purchases", name: "Planned Purchases", planned: 3000, group: "spendable", cutoffId: currentCutoffId, locked: true },
  { id: "cat-alex", name: "Alex Personal", planned: 2500, group: "personal", cutoffId: currentCutoffId, locked: true },
  { id: "cat-mia", name: "Mia Personal", planned: 2500, group: "personal", cutoffId: currentCutoffId, locked: true },
  { id: "cat-others", name: "Others", planned: 2000, group: "spendable", cutoffId: currentCutoffId, locked: true }
];

const previousCategories: BudgetCategory[] = [
  { id: "prev-debt", name: "Debt Payments", planned: 7500, group: "reserved", cutoffId: previousCutoffId, locked: true },
  { id: "prev-bills", name: "Monthly Bills", planned: 8600, group: "reserved", cutoffId: previousCutoffId, locked: true },
  { id: "prev-family", name: "Family Share", planned: 5000, group: "reserved", cutoffId: previousCutoffId, locked: true },
  { id: "prev-food", name: "Food", planned: 6800, group: "spendable", cutoffId: previousCutoffId, locked: true },
  { id: "prev-parking", name: "Parking", planned: 1500, group: "spendable", cutoffId: previousCutoffId, locked: true },
  { id: "prev-gas", name: "Gas", planned: 3300, group: "spendable", cutoffId: previousCutoffId, locked: true },
  { id: "prev-savings", name: "Savings", planned: 9000, group: "savings", cutoffId: previousCutoffId, locked: true },
  { id: "prev-purchases", name: "Planned Purchases", planned: 2000, group: "spendable", cutoffId: previousCutoffId, locked: true },
  { id: "prev-alex", name: "Alex Personal", planned: 2400, group: "personal", cutoffId: previousCutoffId, locked: true },
  { id: "prev-mia", name: "Mia Personal", planned: 2400, group: "personal", cutoffId: previousCutoffId, locked: true },
...
const currentDailyPlans: DailyBudget[] = [
  { id: "day-0916", date: "2026-09-16", cutoffId: currentCutoffId, planned: 900, categoryPlans: [] },
  { id: "day-0917", date: "2026-09-17", cutoffId: currentCutoffId, planned: 800, categoryPlans: [] },
  { id: "day-0918", date: "2026-09-18", cutoffId: currentCutoffId, planned: 1200, categoryPlans: [] },
  { id: "day-0919", date: "2026-09-19", cutoffId: currentCutoffId, planned: 2000, categoryPlans: [] },
  { id: "day-0920", date: "2026-09-20", cutoffId: currentCutoffId, planned: 1200, categoryPlans: [
    { categoryId: "cat-food", planned: 500 },
    { categoryId: "cat-gas", planned: 500 },
    { categoryId: "cat-parking", planned: 150 },
    { categoryId: "cat-alex", planned: 50 }
  ] },
  { id: "day-0921", date: "2026-09-21", cutoffId: currentCutoffId, planned: 1100, categoryPlans: [] },
  { id: "day-0922", date: "2026-09-22", cutoffId: currentCutoffId, planned: 1000, categoryPlans: [] },
  { id: "day-0923", date: "2026-09-23", cutoffId: currentCutoffId, planned: 1400, categoryPlans: [] },
  { id: "day-0924", date: "2026-09-24", cutoffId: currentCutoffId, planned: 950, categoryPlans: [] },
  { id: "day-0925", date: "2026-09-25", cutoffId: currentCutoffId, planned: 1500, categoryPlans: [] },
  { id: "day-0926", date: "2026-09-26", cutoffId: currentCutoffId, planned: 1100, categoryPlans: [] },
  { id: "day-0927", date: "2026-09-27", cutoffId: currentCutoffId, planned: 1300, categoryPlans: [] },
  { id: "day-0928", date: "2026-09-28", cutoffId: currentCutoffId, planned: 950, categoryPlans: [] },
  { id: "day-0929", date: "2026-09-29", cutoffId: currentCutoffId, planned: 1200, categoryPlans: [] },
  { id: "day-0930", date: "2026-09-30", cutoffId: currentCutoffId, planned: 1600, categoryPlans: [] }
];
...
export const createDemoBudgetState = (): BudgetState => ({
  users: [
    { id: "user-alex", householdId: "household-alex-mia", name: "Alex", role: "husband" },
    { id: "user-mia", householdId: "household-alex-mia", name: "Mia", role: "wife" }
  ],
  household: {
    id: "household-alex-mia",
    name: "Alex and Mia Household",
    husbandUserId: "user-alex",
    wifeUserId: "user-mia"
  },
  profile: {
    husbandName: "Alex",
  ...
  incomes: [
    { id: "inc-alex-salary", source: "Alex Salary", person: "Husband", amount: 32000, date: "2026-09-16", cutoffId: currentCutoffId, type: "Salary", notes: "Main salary" },
    { id: "inc-mia-salary", source: "Mia Salary", person: "Wife", amount: 28000, date: "2026-09-16", cutoffId: currentCutoffId, type: "Salary", notes: "Main salary" },
    { id: "inc-side", source: "Weekend freelance", person: "Shared", amount: 3000, date: "2026-09-18", cutoffId: previousCutoffId, type: "Freelance" },
    { id: "inc-prev-alex", source: "Alex Salary", person: "Husband", amount: 32000, date: "2026-09-01", cutoffId: previousCutoffId, type: "Salary" },
    { id: "inc-prev-mia", source: "Mia Salary", person: "Wife", amount: 28000, date: "2026-09-01", cutoffId: previousCutoffId, type: "Salary" }
  ],
  ...
  expenses: [
    ...
    { id: "exp-2", name: "Parking near office", amount: 150, category: "Parking", paidBy: "Alex", date: "2026-09-16", paymentMethod: "Cash", cutoffId: currentCutoffId },
    ...
    { id: "exp-5", name: "Coffee and snacks", amount: 260, category: "Food", paidBy: "Mia", date: "2026-09-18", paymentMethod: "Maya", cutoffId: currentCutoffId },
    ...
    { id: "exp-8", name: "Work lunch", amount: 250, category: "Food", paidBy: "Alex", date: "2026-09-20", paymentMethod: "Cash", cutoffId: currentCutoffId },
    ...
    { id: "exp-10", name: "Parking", amount: 150, category: "Parking", paidBy: "Alex", date: "2026-09-20", paymentMethod: "Cash", cutoffId: currentCutoffId },
    { id: "exp-11", name: "Mia personal skincare", amount: 700, category: "Mia Personal", paidBy: "Mia", date: "2026-09-20", paymentMethod: "Debit Card", cutoffId: currentCutoffId },
  ...
  familyShares: [
    { id: "family-parents", recipient: "Alex's Parents", relationship: "Parents", budget: 2500, actualAmount: 2500, date: "2026-09-19", cutoffId: currentCutoffId, notes: "Monthly help" },
    { id: "family-inlaws", recipient: "Mia's Parents", relationship: "Parents-In-Law", budget: 2500, actualAmount: 0, date: "2026-09-27", cutoffId: currentCutoffId, notes: "Scheduled" }
  ],
